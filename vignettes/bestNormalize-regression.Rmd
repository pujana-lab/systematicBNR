...
y = inmuneAssociation::preprocess_effect_variable(random_dataset$signature, allow_orderNorm = FALSE)
plot(
...
models = inmuneAssociation::stepwise_fit_model(y, phenotypes, scope = list(
  lower = ~ 1,
  upper = ~ .
))
